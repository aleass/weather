...
func WeatherInfo() string {
	...
	return fmt.Sprintf(weather, common.SubStr, weatherResp.Now.Temp, weatherResp.Now.Text, weatherResp.Now.WindDir, weatherResp.Now.WindSpeed, weatherResp.Now.Vis)
}
